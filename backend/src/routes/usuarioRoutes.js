...
router.get("/:id/perfil", autenticarToken, usuarioController.buscarPerfil);
router.put("/:id/perfil", autenticarToken, usuarioController.atualizarPerfil);
router.put("/:id/perfil/senha", autenticarToken, usuarioController.alterarMinhaSenha);
